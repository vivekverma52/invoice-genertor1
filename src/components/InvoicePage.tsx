      ...
      <Page className="invoice-wrapper" pdfMode={pdfMode}>
        ...
        <View className="flex" pdfMode={pdfMode}>
          ...
          <EditableInput
              ...
              placeholder="Madan Gupta Vegetable and Fruit Supplier"
              value={invoice.companyName || "Madan Gupta Vegetable and Fruit Supplier"}
              onChange={(value) => handleChange('companyName', value)}
              pdfMode={pdfMode}
             />
            <EditableInput
              placeholder="Company's Address"
              value={invoice.companyAddress || "DANISH KUNJ CHAURAHA"}
              onChange={(value) => handleChange('companyAddress', value)}
              pdfMode={pdfMode}
            />
            <EditableInput
              placeholder="Contact "
              value={invoice.companyAddress2 || "Mob - 9752022683"}
        ...
        <View className="mt-20" pdfMode={pdfMode}>
          <EditableInput
            ...
            placeholder='Thanks for Visiting the Shop'
            value={invoice.notesLabel|| 'Thanks for Visiting the Shop'}
